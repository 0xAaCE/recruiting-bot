...
**Description**: Create a responsive header with the Hiro logo/name on the left and a navigation link to `/chat` ("Try Demo") on the right. Use Tailwind for styling.
**Acceptance criteria**:
